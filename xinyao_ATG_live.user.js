...
(() => {
  ...
  if (window.__XIANYAO_ATG_LIVE_V200__) return;
  window.__XIANYAO_ATG_LIVE_V200__ = true;
  ...
  function updateGeneralFromEngine(
    finalState
  ) {
    let changed = false;
  ...
  async function inspectMessageData(
    data
  ) {
    try {
      if (
  ...
  function mountPanel() {
    ...
    style.textContent = `
      ...
      #xinyaoATGLiveV200 .xinyaoRow span {
        opacity:.78;
      }

      #xinyaoATGLiveV200 .xinyaoRow b {
        font-size:12px;
        font-weight:800;
      }

      #xinyaoATGLiveV200 .xinyaoLine {
        height:1px;
        margin:7px 0;
        background:rgba(255,255,255,.14);
      }

      #xinyaoATGLiveV200 input::placeholder {
